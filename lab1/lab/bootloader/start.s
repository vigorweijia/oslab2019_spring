...
#	movw 4(%esp), %ax
#	movw %ax, %bp
#	movw 6(%esp), %cx #length of the string
#	movw $0x1301, %ax #ah = 0x13 print the string
#	movw $0x000c, %bx #bh = 0x00 black background bl = 0x0c red character
#	movw $0x0000, %dx #print ar line 0 col 0
#	int $0x10
#	popw %bp
#	ret
...
displayStr:
	movl 4(%esp), %ebx
	movl 8(%esp), %ecx
	movl $((80*5+0)*2), %edi #print hello world at line 5
	movb $0x0c, %ah #black background and red characters
nextChar:
	movb (%ebx), %al 
	movw %ax, %gs:(%edi) # write graphics memory
	addl $2, %edi # %edi is the address of the character
	incl %ebx
